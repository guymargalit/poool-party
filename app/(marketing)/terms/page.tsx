...
export default function TermsPage() {
  return (
    <main className="p-4">
      <div className="flex items-center font-bold text-primary text-center text-2xl">
        Terms and Conditions
      </div>

      <div className="flex items-center font-bold text-primary text-center text-lg mt-2.5">
        OVERVIEW
      </div>
      ...
      <p className="font-normal text-primary text-base">
        ...
        or implied her express or implied, including all implied warranties or
        conditions of merchantability, merchantable quality, fitness for a
        particular purpose, durability, title, and non-infringement. In no case
        shall Birthday Guy, LLC, our directors, officers, employees, affiliates,
