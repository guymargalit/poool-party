    ...
    <div className="relative w-full overflow-hidden" {...props}>
      <div className="relative w-full overflow-hidden z-10">
        <div className="relative overflow-hidden animate-slideUp">
          <div className="absolute top-[7.2%] left-[14.5%] w-[71%] h-[77.8%] overflow-hidden z-10">
            <div className="absolute inset-0 overflow-hidden z-20"></div>
            <video
          ...
          <svg
            ...
            className="relative block w-full h-auto select-none pointer-events-none backface-hidden z-20"
          >
