...
const Terms = ({ darkMode, setDarkMode }) => {
  return (
    <Page
      heading={<Title>Terms and Conditions</Title>}
      darkMode={darkMode}
    ...
    >
      ...
      <Text>
        This website is operated by Birthday Guy, LLC. Throughout the site, the
        terms “we”, “us” and “our” refer to Birthday Guy, LLC. Birthday Guy, LLC
      ...
      <Text>Prices for our products are subject to change without notice.</Text>
      ...
      <Subtitle>SECTION 5 - PRODUCTS OR SERVICES (if applicable)</Subtitle>
      ...
      <Text>
        ...
        Service. SECTION 8 - THIRD-PARTY LINKS
      </Text>
      <Text>
      ...
      <Text>
        ...
        third-party. SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS
      </Text>
      <Text>
      ...
      <Text>
        ...
        any related website for violating any of the prohibited uses. SECTION 13
      ...
      <Text>
        ...
        durability, title, and non-infringement. In no case shall Birthday Guy,
        LLC, our directors, officers, employees, affiliates, agents,
      ...
      <Text>
        You agree to indemnify, defend and hold harmless Birthday Guy, LLC and
      ...
      <Text>
        ...
        laws of 4165 Cooper Ct, Boulder, CO, 80303, United States.
      </Text>
